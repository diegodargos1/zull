...
import {postTempCliente, postTempContato} from '../../../action/register-post';
...
class FormCliente extends React.Component{
    constructor(props){
        ...
        this.state = {
            ...
            fieldSize: (props.fieldSize) ? props.fieldSize : "5",
    ...
    handleSubmit = async (e) => {
        ...
        await this.setState({
            ...
            edited: {
                ...this.state.edited,
                cliente: clienteCod.cod
            }
        });
        const contato = await postTempContato(this.state.edited);
        if(!contato.error){
            alert(contato.msg);
            return false;
        }
        ...
        alert("Cliente salvo!")
        this.props.formCliente(clienteCod.cod, contato.contato);
