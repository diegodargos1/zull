...
import {postConsulta, postConsultaOrcamentoDetalhePadrao} from '../../../action/consulta-post';
import OrcamentoPromocao from '../../../containers/orcamento/orcamentopromocaopadrao';
...
class Consulta extends React.Component{
    ...
    async getDetalhesFromServer(e){
        document.getElementById("loading").style.display = "block";
        let datasv = await postConsultaOrcamentoDetalhePadrao(e);
    ...
    render(){
        ...
        if(this.state.page  === "table"){
            ...
            <>
                ...
                <OrcamentoPromocao consulta={false} allData={this.state.cliente} voltar={this.handleOnClick} readonly={this.state.readonly} novaConsulta={this.getNewPage}/>
